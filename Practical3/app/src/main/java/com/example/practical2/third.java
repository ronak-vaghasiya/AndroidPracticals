...
public class third extends Fragment {
    ...
    public void setCourseText(String value){
        tv1= mView.findViewById(R.id.txtCourse);
        if(value.equals("Diploma")){
            tv1.setText("You have selected: Diploma course");
        } else if (value.equals("Btech")) {
            tv1.setText("You have selected: Btech course");
        } else if (value.equals("Msc")) {
            tv1.setText("You have selected: Msc course");
        }
        else {
            tv1.setText("none");
        }
